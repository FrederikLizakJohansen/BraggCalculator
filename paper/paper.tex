...
revision. Figure~\ref{fig:scaling} reports single-threaded NumPy results on an
Intel Core Ultra 5 225U using seven interleaved repeats. ``Supplied sites'' means
sites in the structure passed to both calculators, before primitive-cell
reduction. For P1 cells containing 4--256 irreducible sites, cached calculations
are 8.5--35.5 times faster than pymatgen and complete end-to-end calculations
are 7.9--13.7 times faster. For NaCl supercells containing 8--512 supplied sites
...
\begin{figure}[htbp]
  ...
  end-to-end timings include all preprocessing.}
  \label{fig:scaling}
\end{figure}
