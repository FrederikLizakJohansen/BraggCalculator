...
\citep{johansen2024}, a GPU-accelerated package that computes powder and total
scattering from atomic pair distances using the Debye scattering equation.
\texttt{DebyeCalculator} supports finite, disordered, and non-crystalline
structures through real-space pair summation, while \texttt{BraggCalculator}
uses translational symmetry and reciprocal-space reflections for periodic
crystals.
